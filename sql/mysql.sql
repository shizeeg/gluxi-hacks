...
CREATE TABLE `conference_alists` (
  ...
  PRIMARY KEY (id),
  UNIQUE KEY  (`conference_id`,`list`,`matcher`, `test`, `value`, `child_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
-- MySQL dump 10.11
--
-- Host: localhost    Database: gluxi
-- ------------------------------------------------------
-- Server version	5.0.51a-13
...
-- Dump completed on 2008-09-08 20:42:29
